    ...
    return (
        <View className="dark:bg-zinc-900">
            ...
            <View className="h-full items-center w-80 mx-auto">
                ...
                <Text className="text-bold text-2xl mt-10 mb-10 dark:text-gray-200">{userInfo.name}</Text>
                <TouchableOpacity
                    className="bg-violet-600 p-4 w-full rounded-full"
                    onPress={handleLogout}
                    
                >
                    <Text className="text-white text-xl text-center font-bold">Logout</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
